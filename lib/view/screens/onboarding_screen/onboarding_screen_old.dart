...
import 'package:dataspikemobilesdk/view/ui/custom_checkbox_tile.dart';
...
class OnboardingScreenOld extends StatefulWidget {
  ...
  @override
  State<OnboardingScreenOld> createState() => _OnboardingScreenStateOld();
}

class _OnboardingScreenStateOld extends State<OnboardingScreenOld> {
...
class _OnboardingSlideOld {
  final String image;
  final String text;
  const _OnboardingSlideOld({required this.image, required this.text});
}
